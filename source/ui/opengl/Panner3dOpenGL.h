...
public:
    MainContentComponent()
    {
        ...
        if (true) {
            ...
            rotationYSlider.setVisible(false);
            rotationZSlider.setVisible(false);
            cameraXSlider.setVisible(false);
            cameraYSlider.setVisible(false);
            cameraZSlider.setVisible(false);
        }
    ...
    void render() override
    {
        ...
        juce::OpenGLHelpers::clear(juce::Colour(0xff151517));
    ...
    void setVisualPosition(float x, float y, float z) {
        rotationXSlider.setValue(x, juce::sendNotification);
        rotationYSlider.setValue(y, juce::sendNotification);
        rotationZSlider.setValue(z, juce::sendNotification);
    }
